...
To install or update swivm, you can use the [install script](https://github.com/fnogatz/swivm/blob/v0.2.3/install.sh) using cURL:

    curl -o- https://raw.githubusercontent.com/fnogatz/swivm/v0.2.3/install.sh | bash

or Wget:

    wget -qO- https://raw.githubusercontent.com/fnogatz/swivm/v0.2.3/install.sh | bash
